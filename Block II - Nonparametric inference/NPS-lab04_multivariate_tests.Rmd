...
$$T_0 =||\bar{\mathbf{x}}_1 -\bar{\mathbf{x}}_2||_2^2 =(\bar{\mathbf{x}}_1-\bar{\mathbf{x}}_2)^\intercal(\bar{\mathbf{x}}_1-\bar{\mathbf{x}}_2) $$ where $||.||_2$ denotes the euclidean norm in $\mathbb{R}^{48}$.
