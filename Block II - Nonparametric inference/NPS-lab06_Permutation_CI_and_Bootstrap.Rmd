...
author: "Nonparametric Statistics A.Y. 2025-2026"
date: 2025-10-21
output:
  html_document: 
    df_print: paged
...
```{r}
parallel::clusterExport(cl,varlist=list("data","uni_t_perm"))
```
...
```{r}
CI_list = lapply(alpha_grid,CI_calc)
...
T20 <- (Tukey_median-c_0)  %*% (Tukey_median-c_0) 
...
summary(chrono)
attach(chrono)
boxplot(chrono$reaction_time ~ chrono$athlete)
```
